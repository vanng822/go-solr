...
func mockSuccessStandaloneSoftCommit(w http.ResponseWriter, req *http.Request) {
	logRequest(req)
	io.WriteString(w, `{"responseHeader":{"status":0,"QTime":5}}`)
}
...
func mockStartServer() {
	...
	http.HandleFunc("/standalonesoftcommit/core0/update/", mockSuccessStandaloneSoftCommit)
